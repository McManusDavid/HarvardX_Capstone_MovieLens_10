...
```{r Packages_Apx, ref.label='Packages', eval=FALSE}

```

```{r Memory_Allocation_Apx, ref.label='Memory_Allocation', eval=FALSE}

```

```{r Creating_Dataset_Apx, ref.label='Creating_Dataset', eval=FALSE}
...
```{r Head_Apx, ref.label='Head', eval=FALSE}

```

```{r User/Movie_Summary_Apx,ref.label='User/Movie_Summary', eval=FALSE}
...
```{r Most_Rated_Movies_Apx, ref.label='Most_Rated_Movies', eval=FALSE}

```

```{r Least_Rated_Movies_Apx, ref.label='Least_Rated_Movies', eval=FALSE}

```

```{r Top_10_Most/Least_Rated_Movies Apx, ref.label='Top_10_Most/Least_Rated_Movies', eval=FALSE}

```

```{r Number_of_Ratings_for_Top10_Apx, ref.label='Number_of_Ratings_for_Top10', eval=FALSE}

```

```{r Most_Rated_Genres_Apx, ref.label='Most_Rated_Genres', eval=FALSE}

```

```{r Users_by_Number_of_Ratings_Apx, ref.label='Users_by_Number_of_Ratings', eval=FALSE}

```

```{r Rating_by_Frequency_Apx, ref.label='Rating_by_Frequency', eval=FALSE}

```

#### Analysing the Mean Ratings
```{r Mean_Rating_by_Genre_Apx, ref.label='Mean_Rating_by_Genre', eval=FALSE}

```


```{r Mean_by_Year_of_Release_Apx, ref.label='Mean_by_Year_of_Release', eval=FALSE}

```

```{r Mean_by_Release_by_Genre_Apx, ref.label='Mean_by_Release_by_Genre', eval=FALSE}

```

```{r Date_v_Release_Apx, ref.label='Date_v_Release', eval=FALSE}

```

```{r Date_v_Release_by_Genre_Apx, ref.label='Date_v_Release_by_Genre', eval=FALSE}

```

### Recommendation Systems

```{r Defining_RMSE_Apx, ref.label='Defining_RMSE', eval=FALSE}

```

```{r Creating_Test_and_Train_Sets_Apx, ref.label='Creating_Test_and_Train_Sets', eval=FALSE}

```

#### Mean and Biases Based Models

```{r Simple_Mean_Apx, ref.label='Simple_Mean', eval=FALSE}

```

```{r Mean_plus_Movie_Bias_Apx, ref.label='Mean_plus_Movie_Bias', eval=FALSE}

```

```{r Mean_Movie_and_User_Bias_Apx, ref.label='Mean_Movie_and_User_Bias', eval=FALSE}

```

```{r Mean_Movie_User_and_Release_Year_Apx, ref.label='Mean_Movie_User_and_Release_Year', eval=FALSE}

```

```{r Mean_Movie_User_Release_Year_and_Genre_Bias_Apx, ref.label='Mean_Movie_User_Release_Year_and_Genre_Bias', eval=FALSE}

```

```{r Mean_Movie_User_Relase_Year_by_Genre_Bias_Apx, ref.label='Mean_Movie_User_Relase_Year_by_Genre_Bias', eval=FALSE}

```

```{r Mean_Movie_User_and_Delayed_Review_Bias_Apx, ref.label='Mean_Movie_User_and_Delayed_Review_Bias', eval=FALSE}

```

```{r Mean_Movie_User_Delayed_Review_and_Genre_Bias_Apx, ref.label='Mean_Movie_User_Delayed_Review_and_Genre_Bias', eval=FALSE}

```

```{r Mean_Movie_User_Delayed_Review_by_Genre_Bias_Apx, ref.label='Mean_Movie_User_Delayed_Review_by_Genre_Bias', eval=FALSE}

```

```{r Investagating_NA_in_M_M_U_DR_by_G_Bias_Apx, ref.label='Investagating_NA_in_M_M_U_DR_by_G_Bias', eval=FALSE}

```

#### Regularization

```{r PLS_Find_Lambda_Apx, ref.label='PLS_Find_Lambda', eval=FALSE}

```

```{r Plenalised_Least_Squares_Apx, ref.label='Plenalised_Least_Squares', eval=FALSE}

```

```{r Regularized_Movie_and_User_Bias_Apx, ref.label='Regularized_Movie_and_User_Bias', eval=FALSE}

```

```{r Regularized_Movie_plus_User_Bias_with_Release_Year_by_Genre_Bias_Apx, ref.label='Regularized_Movie_plus_User_Bias_with_Release_Year_by_Genre_Bias', eval=FALSE}

```

#### Matrix Factorization

```{r Recosystem_Apx, ref.label='Recosystem', eval=FALSE}

```

#### Final Validation 

```{r Final_Validation_Recosystem_Apx, ref.label='Final_Validation_Recosystem', eval=FALSE}
